...
def not_blank(question): 
    ...
    while not valid:
        ...
        if response !="":
            ...
            # If input is not blank it returns the response to title class 
        else:
...
def collect_menu():
    print("") # Prints blank line
    question = ("Please enter your First Name ")  #Sets statement as question
    ...
    print("")
    print(f"\n Customer Name: {customer_details['name']} \n Customer Phone: {customer_details['phone']}") #prints customer details
